...
# input files
agents_file = 'data/dummy_agents.csv'
bldgs_file = 'data/dummy_bldgs.csv'
...
max_bld_id = 400000 # agent ids should be greater than building ids, this is the max id for buildings

# infection
norm_factor = 1 # normalizing factor for contagion probability
